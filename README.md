# Interface de uma Lista Duplamente encadeada em C
...
A álgebra dessa estrutura de dados foi construída a partir do primeiro nó da lista \(head\), então apesar de ser duplamente encadeada, e não simplesmente encadeada, ela não aproveita 100% da natureza
